...
1. Make sure [Quarto](https://quarto.org/) is installed on your system.

2. Git clone and enter this repository:
...
2. Commit changes. Optionally, preview changes during local development by
